...
VALUES
(2, 'Curso de Programação', 'Aprenda a programar em diversas linguagens', 99.99, 30, 30),
(2, 'Curso de Design Gráfico', 'Domine as técnicas de design e criação visual', 149.99, 25, 25);
